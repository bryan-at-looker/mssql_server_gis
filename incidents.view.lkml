...
#     html: <a target="_parent" href="/dashboards/1262?Area%20Name='{{ geo_areas.area_name._value }}'">{{rendered_value}}</a> ;;
    html: <a target="_parent" href="https://localhost:8000/iframebroadcast.html#iframe-2-id=https://master.dev.looker.com/embed/dashboards/1262?Area%20Name='{{ geo_areas.area_name._value }}'">{{value}}</a>;;
  }
