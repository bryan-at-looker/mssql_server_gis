...
#     html: <a target="_parent" href="/dashboards/1262?Area%20Name='{{ geo_areas.area_name._value }}'">{{rendered_value}}</a> ;;
    html: <a target="_parent" href="http://localhost:8000/iframebroadcast.html#ifr2=https://master.dev.looker.com/embed/dashboards/1262?Area%20Name='{{ geo_areas.area_name._value }}'">{{value}}</a>;;
  }
